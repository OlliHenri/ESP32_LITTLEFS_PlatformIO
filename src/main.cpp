...
simple LITTLEFS template

Uses
- espressif LOGGING
- LittleFS with file uploadinto littlefs file system with PlatformIO task
- platformio.ini is setup for LITTLEFS, good to use as template

************************************************************/

static const char *TAG = "Olli";

#include "esp_log.h" // if ESP8266 supports logging we need to change this or take it out for ESP8266

#include <Arduino.h>
#include "FS.h"
//#include <LittleFS.h>  use this for ESP8266 and change LITTLEFS to LittleFS
#include <LITTLEFS.h>
#include <time.h>
